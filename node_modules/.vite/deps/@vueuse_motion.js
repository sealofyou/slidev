...
var int = __spreadProps(__spreadValues({}, number2), {
        ...
        if (target && target[key] && isNumber(target[key])) {
          ...
          if (variantsRef && variantsRef.value) {
            ...
            if (variantsRef.value.visibleOnce) {
              ...
              variantsRef.value.visibleOnce.transition = __spreadProps(__spreadValues({}, variantsRef.value.visibleOnce.transition), {
                delay
              });
            }
          }
